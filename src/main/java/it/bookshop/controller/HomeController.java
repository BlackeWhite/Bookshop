...
public class HomeController {
	...
	public String home(Locale locale, Model model, Authentication authentication,
		...
		List<Author> topFiveAuthor = this.authorService.findBestSellingAuthor(); // restituisce la lista degli autori(i primi 5) che hanno venduto pi� copie di libri
		...
		List<Book> topFiveBestSellersBooks = bookService.findFiveBestSellingBook(); // restituisce la lista dei primi 5 libri pi� venduti
	...
	public String populatedb(Locale locale, Model model) {
		...
		bookService.create("Michael", "Crichton", "198934345798876", "Jurassic Park", publish_date3, publish_date3, 12,
				18.30, seller2, 267, "Alan Grant è un paleontologo che ...", "12.jpg",
		...
		bookService.create("Stephen W.", "Hawking", "5667899121887",
				...
				280, "Il Big Bang � stato un evento ...", "13.jpg", Arrays.asList("Divulgativo"), 0.20);
